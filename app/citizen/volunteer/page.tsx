  ...
  return (
    <AppShell>
      <div className="max-w-4xl mx-auto space-y-8 pb-20">
        ...
        {submitted ? (
          <Card className="p-12 text-center border-rose-100 dark:border-rose-900/30 bg-rose-50/50 dark:bg-rose-950/20 shadow-sm rounded-2xl flex flex-col items-center justify-center min-h-[400px]">
            ...
            <Button onClick={() => setSubmitted(false)} variant="outline" className="text-rose-600 dark:text-rose-400 border-rose-200 dark:border-rose-900/50 hover:bg-rose-50 dark:hover:bg-rose-900/20">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="md:col-span-2">
              <Card className="p-8 border-slate-100 dark:border-slate-800 shadow-sm rounded-2xl bg-white dark:bg-slate-900">
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div className="space-y-2">
                      ...
                      <Input 
                        ...
                        className="bg-slate-50 dark:bg-slate-950 dark:border-slate-800 text-slate-900 dark:text-slate-100"
                      />
                    </div>
                    <div className="space-y-2">
                      <label className="text-sm font-semibold text-slate-700 dark:text-slate-300">
                      ...
                      <Input required type="tel" placeholder="+91 9876543210" className="bg-slate-50 dark:bg-slate-950 dark:border-slate-800 text-slate-900 dark:text-slate-100" />
                    </div>
                  </div>
                  ...
                  <div className="space-y-2">
                    ...
                    <Input required placeholder={language === 'en' ? 'e.g., Ward 142, Anna Nagar' : 'எ.கா., வார்டு 142, அண்ணா நகர்'} className="bg-slate-50 dark:bg-slate-950 dark:border-slate-800 text-slate-900 dark:text-slate-100" />
                  </div>
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                      {[
                        ...
                        <label key={idx} className="flex items-center gap-3 p-3 border border-slate-200 dark:border-slate-800 rounded-xl cursor-pointer hover:bg-slate-50 dark:hover:bg-slate-800/50 transition-colors">
                          <input type="checkbox" className="w-4 h-4 text-rose-600 rounded border-slate-300 dark:border-slate-700 dark:bg-slate-950 focus:ring-rose-500" />
                  ...
                  <div className="space-y-2">
                    ...
                    <select className="w-full h-10 px-3 rounded-md border border-slate-200 dark:border-slate-800 bg-slate-50 dark:bg-slate-950 text-slate-900 dark:text-slate-100 text-sm focus:outline-none focus:ring-2 focus:ring-rose-500">
            ...
            <div className="space-y-6">
              <Card className="p-6 border-rose-100 dark:border-rose-900/30 bg-rose-50/50 dark:bg-rose-950/20 shadow-sm rounded-2xl">
                <h3 className="font-bold text-slate-900 dark:text-white mb-4">{language === 'en' ? 'Why Volunteer?' : 'ஏன் தன்னார்வலராக வேண்டும்?'}</h3>
              ...
              <Card className="p-6 border-slate-100 dark:border-slate-800 bg-white dark:bg-slate-900 shadow-sm rounded-2xl">
                <h3 className="font-bold text-slate-900 dark:text-white mb-4">{language === 'en' ? 'Upcoming Drives' : 'வரவிருக்கும் நிகழ்வுகள்'}</h3>
                <div className="space-y-4">
                  <div className="border-l-2 border-rose-500 dark:border-rose-400 pl-4">
                    <p className="font-semibold text-sm text-slate-800 dark:text-slate-200">{language === 'en' ? 'Marina Beach Cleanup' : 'மெரினா கடற்கரை சுத்தம்'}</p>
                    <div className="flex items-center gap-2 mt-1 text-xs text-slate-500 dark:text-slate-400">
                      <Calendar className="w-3 h-3" /> {language === 'en' ? 'Next Sunday, 6 AM' : 'அடுத்த ஞாயிறு, காலை 6 மணி'}
                    </div>
                  </div>
                  <div className="border-l-2 border-rose-500 dark:border-rose-400 pl-4">
                    <p className="font-semibold text-sm text-slate-800 dark:text-slate-200">{language === 'en' ? 'Traffic Awareness Drive' : 'போக்குவரத்து விழிப்புணர்வு'}</p>
                    <div className="flex items-center gap-2 mt-1 text-xs text-slate-500 dark:text-slate-400">
